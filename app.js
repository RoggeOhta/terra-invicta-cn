...
function nodeSelected(event) {
    ...
    // This is where the node state being set
...
function init() {
    const fetchLocPaths = [
        "TITechTemplate.chs",
        "TIProjectTemplate.chs",
        "TIEffectTemplate.chs",
        "TIBatteryTemplate.chs",
        "TIDriveTemplate.chs",
        "TIGunTemplate.chs",
        "TIHabModuleTemplate.chs",
        "TIHeatSinkTemplate.chs",
        "TILaserWeaponTemplate.chs",
        "TIMagneticGunTemplate.chs",
        "TIMissileTemplate.chs",
        "TIParticleWeaponTemplate.chs",
        "TIPlasmaWeaponTemplate.chs",
        "TIPowerPlantTemplate.chs",
        "TIRadiatorTemplate.chs",
        "TIShipArmorTemplate.chs",
        "TIShipHullTemplate.chs",
        "TIUtilityModuleTemplate.chs",
    ]
    let fetchedTexts = []
...
function determineLevel(tech, validNodes) {
    if (tech.prereqs === undefined) return 0
